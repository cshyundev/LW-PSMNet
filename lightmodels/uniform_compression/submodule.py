...
class feature_extraction(nn.Module):
    def __init__(self):
        ...
        # params: 19488 -> 5136
        self.firstconv = nn.Sequential(# params: 928 -> 464
                                       convbn(3, 16, 3, 2, 1, 1), # convbn(3, 32, 3, 2, 1, 1),
                                       nn.ReLU(inplace=True),
                                       # params: 9280 -> 2336
                                       convbn(16, 16, 3, 1, 1, 1), # convbn(32, 32, 3, 1, 1, 1),
                                       nn.ReLU(inplace=True),
                                       # params: 9280 -> 2336
                                       convbn(16, 16, 3, 1, 1, 1), # convbn(32, 32, 3, 1, 1, 1),
                                       nn.ReLU(inplace=True))
        ...
        self.layer1 = self._make_layer(BasicBlock, 16, 3, 1, 1, 1)

        # params: 1167488 -> 292928
        # self.layer2 = self._make_layer(BasicBlock, 64, 16, 2, 1, 1)
        self.layer2 = self._make_layer(BasicBlock, 32, 16, 2, 1, 1)

        # params: 820992 -> 205696
        # self.layer3 = self._make_layer(BasicBlock, 128, 3, 1, 1, 1)
        self.layer3 = self._make_layer(BasicBlock, 64, 3, 1, 1, 1)

        # params: 886272 -> 221952
        # self.layer4 = self._make_layer(BasicBlock, 128, 3, 1, 1, 2)
        self.layer4 = self._make_layer(BasicBlock, 64, 3, 1, 1, 2)

        # params: 4160 -> 2112
        self.branch1 = nn.Sequential(nn.AvgPool2d((64, 64), stride=(64, 64)),
                                     convbn(64, 16, 1, 1, 0, 1), # convbn(128, 32, 1, 1, 0, 1),
                                     nn.ReLU(inplace=True))
        ...
        # params: 372992 -> 260352
        self.lastconv = nn.Sequential(convbn(160, 128, 3, 1, 1, 1), # convbn(320, 128, 3, 1, 1, 1),
                                      nn.ReLU(inplace=True),
