...
class feature_extraction(nn.Module):
    def __init__(self):
        ...
        self.layer1 = self._make_layer(BasicBlock, 8, 3, 1, 1, 1)
        self.layer2 = self._make_layer(BasicBlock, 16, 16, 2, 1, 1)
        self.layer3 = self._make_layer(BasicBlock, 32, 3, 1, 1, 1)
